   ...
   public function store(Request $request)
{
    ...
    public function destroy($id)
    {
        ...
        $filename = $slide->getRawOriginal('image');
        $path = 'slides/' . $filename;


        // Delete image from custom 'slides' disk
         if (Storage::disk('slides')->exists($path)) {
            Storage::disk('slides')->delete($path);
        }
    ...
    public function update(Request $request, Slide $slide)
{
    ...
    try {
        if ($request->hasFile('image')) {
            // Delete old image from custom 'slides' disk
            if ($slide->image && Storage::disk('slides')->exists('slides/' . $slide->image)) {
                Storage::disk('slides')->delete('slides/' . $slide->image);
            }
