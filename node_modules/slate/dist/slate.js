(function (global, factory) {
  ...
  function positions(editor) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    return /*#__PURE__*/regenerator.mark(function _callee() {
      var _options$at, at, _options$unit, unit, _options$reverse, reverse, _options$voids, voids, range, _Range$edges, _Range$edges2, start, end, first, isNewBlock, blockText, distance, leafTextRemaining, leafTextOffset, _iterator, _step, _step$value, node, path, e, s, isFirst, calcDistance;
      return regenerator.wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
          ...
          case 15:
            ...
            _context.next = 22;
            return Editor.end(editor, Path.previous(path));
          case 22:
            return _context.abrupt("continue", 58);
          case 25:
            _context.next = 27;
            return Editor.start(editor, Path.next(path));
          case 27:
            return _context.abrupt("continue", 58);
          case 28:
